...
public class RedisClient {
    ...
    private void KeyOperate() {
         ...
         */
        PersonModel personModel = new PersonModel("费德勒",38);
        shardedJedis.set("PersonModel01",personModel.toString());
        System.out.println(shardedJedis.get("PersonModel01"));
